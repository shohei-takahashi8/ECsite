...
public class CreateUserConfirmAction extends ActionSupport implements SessionAware {
	...
	private String userIdDuplicateMessage;
	...
	public String execute() {
		...
		userIdErrorMessageList = inputChecker.doCheck("ユーザーID", userId, 1, 10, true, false, false, true, false, false);
		...
		|| passwordErrorMessageList.size() > 0) {
			return result;
		} else if(userInfoDAO.checkDuplicate(userId) > 0)  {
			userIdDuplicateMessage = "すでに登録されているユーザーIDです。";
			return result;
		}else {
			if(gender.equals("0")){
				gender = "男性";
	...
	public String getUserIdDuplicateMessage() {
		return userIdDuplicateMessage;
	}

	public void setUserIdDuplicateMessage(String userIdDuplicateMessage) {
		this.userIdDuplicateMessage = userIdDuplicateMessage;
	}
